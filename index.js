...
const tv = data => new tv_new(data);  //wrap constructor
...
//basic
props.basic.map(a => proto[a] = function(x) {
  this._obj[a] = x;
  return this;
});
...
//compose
props.compose.map(a => proto[a] = function() {
  this._obj[a] = [];
...
//marks
props.mark.map(a => proto[a] = function() {
...
//channels
props.channel.map(a => proto[a] = function(fld, typ, ops) {
  let channel = {};
  if (fld) {
    channel.field = fld;
...
proto.plot = function() { return this };
